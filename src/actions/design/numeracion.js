import { regex, cargaImagen, espacioMiles, cargaFuente, regexFunctions } from '../global/tools'
...
export function rectNumFn(config) {
  ...
  state.show = {
    ...
    tramoLLave: {
      ...
      inicio: regexFunctions(regex(tramoInicio, vars, vt)),
      fin: regexFunctions(regex(tramoFin, vars, vt)),
