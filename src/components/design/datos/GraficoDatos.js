...
export default class GraficoDatos extends Component {
	...
	componentDidUpdate() {
		datos.graficoDatos({ container:$('container'), params:this.state, variables:this.props.variables })
	}
	handleActive(active) {
	...
	render() {
		...
		return (
			<Editor title="Gráfico Datos" params={this.state} store={this.props}>
				...
				<Item id={2} active={active} title="Chart" setActive={::this.handleActive}>
				...
				<Item id={4} active={active} title="Title" setActive={::this.handleActive}>
				...
				<Item id={5} active={active} title="Font" setActive={::this.handleActive}>
				...
				<Item id={6} active={active} title="Lines" setActive={::this.handleActive}>
