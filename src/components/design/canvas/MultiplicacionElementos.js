...
export default class MultiplicacionElementos extends React.Component {
  constructor(props) {
    super(props)
  ...
  componentDidUpdate() {
    acciones.multiplicacionElem({ container:$('container'), params:this.state, variables:this.props.variables, vt:true })
  }
